...
class IsMatchTest extends TestCase
{
    ...
    #[Test]
    public function 正規表現が一致する場合は1を返す()
    {
        $stringable = $this->createMock(Stringable::class);
        $stringable->method('__call')->willReturnCallback(fn () => 'abc123');
    ...
    #[Test]
    public function 正規表現が一致しない場合は0を返す()
    {
        $stringable = $this->createMock(Stringable::class);
        $stringable->method('__call')->willReturnCallback(fn() => 'abcdef');
    ...
    #[Test]
    public function パターンが空文字の場合falseを返す()
    {
        $stringable = $this->createMock(Stringable::class);
        $stringable->method('__call')->willReturnCallback(fn() => 'abcdef');
    ...
    #[Test]
    public function 第二引数未指定の場合falseを返す()
    {
        $stringable = $this->createMock(Stringable::class);
        $stringable->method('__call')->willReturnCallback(fn() => 'abcdef');
