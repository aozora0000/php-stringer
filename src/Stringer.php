...
use Stringer\Macros\Stringer\Password;
...
class Stringer implements Stringable, JsonSerializable
{
    ...
    public function getType(string $name): string
    {
        return match (true) {
            ...
            self::has($name, Closure::class) => 'closure',
            self::has($name, StringerCallable::class) => 'stringer-callable',
            self::has($name, 'class-string') => 'class-string',
            default => 'default',
        };
    }
     ...
     * @return bool
     */
    public static function has(string $name, string $instanceType = 'class-string'): bool
    {
        return match (true) {
